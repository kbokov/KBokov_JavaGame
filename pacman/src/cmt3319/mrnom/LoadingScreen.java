...
public class LoadingScreen extends Screen {
    ...
    /**
     * Loads the whole screen with the allocated images via Pixmap.
     */
    @Override
    public void update(float deltaTime) {
        ...
        Assets.ghost1 = g.newPixmap("ghost1.png", PixmapFormat.ARGB4444);
        ...
        Assets.ghost2 = g.newPixmap("ghost2.png", PixmapFormat.ARGB4444);
